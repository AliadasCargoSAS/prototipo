        ...
        <div class="row">
            <div class="col" id="cont-bloque-corto">
                <div class="card">
                    <div class="card-header" style="background:#0D1326">
                        <div class="row">
                            <div class="col my-auto">
                                <h2>Historial de ambientes de formación</h2>
                            </div>
                            <div class="col text-right">
                                <a href='#' class='btn btn-historial' data-toggle='modal'
                                    data-target='#confirm-restore-items-modal' style="margin-right:10px;">
                                    <i class="fas fa-undo"></i> Restablecer
                                </a>
                                <a href='#' class='btn btn-danger' data-toggle='modal'
                                    data-target='#confirm-suppress-items-modal'>
                    ...
                    $sql2 = mysqli_query ($link, "SELECT COUNT(*) AS TotalRegistros FROM ambientes WHERE Status = 0");
                    ...
                    $sql = "SELECT * FROM ambientes WHERE Status = 0 LIMIT $desde,$porPagina";
                    if($result = mysqli_query($link, $sql)){
                            ...
                            <div class='panel-group'>
                                <div class='panel-heading'>                                   
                                        <div class='busca'>
                                            ...
                                            <input type='search' name='busqueda' id='busqueda' placeholder=' Realizar una búsqueda' title='Buscar' autocomplete='off'>
                                        </div>                                  
                                </div>
                            </div>
                        </div>
                        <br>";
                         ...
                         echo '<div id="confirm-suppress-items-modal" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">			
                                            <div class="modal-header">	
                                                ...
                                                <h4 class="modal-title">Eliminar definitivamente ambientes de formación</h4>
                                                ...
                                                <!-- <form method="POST" action="delete-all.php">-->					
                                                    <p>¿Estas seguro de eliminar definitivamente los ambientes de formación seleccionados?</p>						
                                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">			
                                            <div class="modal-header">	
                                                ...
                                                <h4 class="modal-title">Restablecer ambientes de formación</h4>
                                                <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                ...
                                                <!--  <form method="POST" action="restore-all.php">-->					
                                                    <p>¿Estas seguro de restablecer los ambientes de formación seleccionados?</p>						
                                                </div>
                            ...
                            echo "<p style='text-align:center;' ><em>No hay registros de ambientes de formación eliminados. </em></p>";
                        }
                    } else{
                    ...
                    <?php                                                
                        ...
                        <div class="text-center">
                            <div class="clearfix" style="padding:5px;margin-left:30px;margin-right:30px;">
                                <div class="hint-text">Página <b><?php echo $pagina ;?></b> de <b><?php echo $totalRegistros;?></b> ambientes de formación eliminados</div>
                                <ul class="pagination">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Eliminar definitivamente ambiente de formación</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>

                    <div class="modal-body">
                        <p>¿Estas seguro de eliminar definitivamente el ambiente de formación?</p>
                        <h6><strong>Esta acción es irrevocable</strong></h6>
                    </div>

                    <div class="modal-footer">
                        <input type="button" class="btn btn-light" data-dismiss="modal" value="Cancelar">
                        <a href="suppress.php?IdPrincipal=<?php echo $row['IdPrincipal'] ?>"
                            class="btn btn-danger btn-ok">Eliminar definitivamente</a>
                    </div>
