...
<body>
        ...
        <div class="row">
            <div class="col" id="cont-bloque-corto">
                <div class="card">
                    ...
                    $sql2 = mysqli_query ($link, "SELECT COUNT(*) AS TotalRegistros FROM ambientes WHERE Status = 1");
                    ...
                    $sql = "SELECT * FROM ambientes WHERE Status = 1 LIMIT $desde,$porPagina";
                    if($result = mysqli_query($link, $sql)){
                            ...
                            <div class="row">
                                <div class="msgalerta">
                                    <div class="alert alert-success">
                                        ...
                                        <i class="fas fa-info-circle"></i> Puedes realizar una búsqueda especifíca, ya
                                        sean
                                        ambientes de tipo computo, laboratorios u otros.
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        echo '<form method="POST" action="delete-all.php">';  
                            ...
                            echo "<table class='table table-striped' style='color:#737373;'> ";
                                echo "<thead>";             
                                    echo "<tr>";
                                        ...
                                        echo "<th>Número de ambiente</th>";
                                        echo "<th>Capacidad de aprendices</th>";
                                        echo "<th>Tipo</th>";
                                        echo "<th>Sede</th>";
                                        echo "<th>Torre</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    //Reporte c/u echo "<td id=".$row['IdPrincipal']." onClick='obtenerID(this.id)'>" . $row['Numero'] . "</td>";
                                        echo "<td id=".$row['IdPrincipal']." >" . $row['Numero'] . "</td>";
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">			
                                            <div class="modal-header">	
                                                ...
                                                <h4 class="modal-title">Eliminar ambientes de formación</h4>
                                                ...
                                                <form method="POST" action="delete-all.php">					
                                                    <p>¿Estas seguro de eliminar los ambientes de formación seleccionados?</p>						
                                                </div>
                            ...
                            echo "<p style='text-align:center;' ><em>No hay registros de ambientes de formación, <a href='crear.php' style='text-decoracion:none;'>agrega un nuevo ambiente</a>.  </em></p>";
                    ...
                    <hr style="margin-top:0px">
                        <div class="text-center">
                            <div class="clearfix" style="padding:5px;margin-left:30px;margin-right:30px;">
                                <div class="hint-text">Página <b><?php echo $pagina ;?></b> de <b><?php echo $totalRegistros;?></b> ambientes de formación</div>
                                <ul class="pagination">
                                   
                                    <?php                                                
                                        if($pagina !=1){
                                            ?>
                            <li class="page-item" title="Inicio"><a href="?pagina=<?php echo 1; ?>" class="page-link"><i
                                        style="font-size:12px" class="fas fa-angle-double-left"></i></a></li>
                            <li class="page-item" title="Anterior"><a href="?pagina=<?php echo $pagina-1; ?>"
                                    class="page-link"> <i style="font-size:12px" class="fas fa-angle-left"></i></a></li>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        ...
                        <div class="modal-body">
                            <form role="form">					
                            <p>¿Estas seguro de eliminar el ambiente?</p>						
                        </div>

					<div class="modal-footer">
						<input type="button" class="btn btn-light" data-dismiss="modal" value="Cancelar">                        
                        <a href="delete.php" class="btn btn-danger btn-ok" >Eliminar</a>
					</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-primary" name="importar" value="Importar">
                </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        //OBTENER EL ID POR METODO POST CON UN CLICK
        function obtenerID(clicked_id) {
            //  alert(clicked_id);
            window.open('../../../extra/Reporte-Ambiente?IdPrincipal=' + (clicked_id), '_blank');
        };

        function ReporteAll() {
            window.open('../../../extra/Reporte-Ambientes', '_blank');
        }
    </script>

    <script>
        //OBTENER ID DEL CHECK PARA GENERAR EL PDF ESPECIFICO
        $(document).ready(function () {
            ...
            $('input').on('click', function () {
                ...
                if (ckbox.is(':checked')) {
                    ...
                    //     alert ( $(this).val() ); 
                    //    alert(chkId);        
                    document.getElementById("IdPDF").href = "../../../extra/pdf/Reporte-Ambiente?IdPrincipal=" + chkId
        ...
        $(document).ready(function () {
            ...
            $('input').on('click', function () {
                ...
                if (ckbox.is(':checked')) {
                    ...
                    document.getElementById("IdPDF").href = "../../../extra/pdf/Reporte-Ambientes"
                }
            });
        });
        ...
        $(document).ready(function () {
            ...
            $('input').on('click', function () {
                ...
                if (ckbox.is(':checked')) {
                    ...
                    document.getElementById("IdExcel").href = "../../../extra/excel/excel-ambiente?IdPrincipal=" + chkId
                }
            });
        });
        ...
        $(document).ready(function () {
            ...
            $('input').on('click', function () {
                ...
                if (ckbox.is(':checked')) {
                    ...
                    document.getElementById("IdExcel").href = "../../../extra/excel/excel-ambientes"
                }
            });
        });
