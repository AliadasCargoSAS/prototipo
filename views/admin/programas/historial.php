            ...
            <div class="col" id="cont-bloque-corto">
                <div class="card">
                    <div class="card-header" style="background:#0D1326">
                        <div class="row">
                            <div class="col my-auto">
                                <h2>Historial de programas de formación</h2>
                            </div>
                    ...
                    <?php
                        ...
                        $sql2 = mysqli_query ($link, "SELECT COUNT(*) AS TotalRegistros FROM programas WHERE Status = 0");
                        ...
                        $sql = "SELECT * FROM programas WHERE Status = 0 LIMIT $desde,$porPagina";
                        if($result = mysqli_query($link, $sql)){
                                ...
                                <div class='row'>
                                    <div class='msgalerta' >
                                     <div class='alert alert-success'> 
                                        ...
                                        programas formativos de tipo Técnico o Tecnologo eliminados.                         
                                    </div>                           
                                </div>
                            </div>";
                            ...
                            echo '<form method="POST" action="">';                   
                                ...
                                echo "<table class='table table-striped' style='color:#737373b6;'> ";
                                    echo "<thead>";
                                        echo "<tr>
                                        <th><span class='custom-checkbox'><input type='checkbox' title='Seleccionar todos los programas de formación' id='selectAll'><label for='selectAll'></label></span></th>
                                        <th>ID</th>
                                        <th>Nombre</th>
                                        <th>Tipo</th>
                                        <th>Duración</th>
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        echo "<td>  <a href='#' title='Competencias'><i class='far fa-file-alt'></i> </a>  </td>";
                                        echo "<td>" . $row['Proyecto'] . "</td>";                              
                                        echo "<td>" . $row['Informacion'] . "</td>";
                                        echo "<td>
                                            <a href='restore?IdPrograma=". $row['IdPrograma'] ."' data-toggle='tooltip'><i class='fas fa-undo' title='Restablecer'></i></a> 
                                            <a href='#' data-href='suppress?IdPrograma=". $row['IdPrograma'] ."' data-toggle='modal' data-target='#confirm-eliminar-modal'><i class='fas fa-minus-circle' title='Eliminar definitivamente'></i></a> </td>";
                                            echo "</tr>";
                                    }
                                    echo "</tbody>";   
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">			
                                                <div class="modal-header">	
                                                    ...
                                                    <h4 class="modal-title">Eliminar definitivamente programas de formación</h4>
                                                    ...
                                                    <!-- <form method="POST" action="delete-all">-->					
                                                        <p>¿Estas seguro de eliminar definitivamente los programas de formación seleccionados?</p>						
                                                    </div>
                            
                                                <div class="modal-footer">
                                                    <input type="button" class="btn btn-light" data-dismiss="modal" value="Cancelar">                        
                                                    <!--  <input type="submit" class="btn btn-danger btn-ok" value="Eliminar definitivamente"> -->
                                                    <input type="submit" class="btn btn-danger btn-ok" name="boton_1" id="boton_1" value="Eliminar definitivamente" dir="suppress-all" />
                                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">			
                                                <div class="modal-header">	
                                                    ...
                                                    <h4 class="modal-title">Restablecer programas de formación</h4>
                                                    <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    ...
                                                    <div class="modal-body">
                                                    <!--  <form method="POST" action="restore-all">-->					
                                                        <p>¿Estas seguro de restablecer los programas de formación seleccionados?</p>						
                                                    </div>
                            
                                                <div class="modal-footer">
                                                    <input type="button" class="btn btn-light" data-dismiss="modal" value="Cancelar">  
                                                    <!-- <input type="submit" class="btn btn-historial btn-ok" value="Restablecer"> -->                  
                                                    <input type="submit" class="btn btn-historial btn-ok" name="boton_2" id="boton_2" value="Restablecer" dir="restore-all" />
                                                </div>
                                ...
                                echo "<p style='text-align:center;' ><em>No hay registros de programas de formación eliminados.</em></p>";
                            }
                        } else{
                    ...
                    <?php                                                
                        ...
                        <div class="text-center">
                            <div class="clearfix" style="padding:5px;margin-left:30px;margin-right:30px;">
                                <div class="hint-text">Página <b><?php echo $pagina ;?></b> de <b><?php echo $totalRegistros;?></b> programas de formación eliminados</div>
                                <ul class="pagination">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					...
					<div class="modal-footer">
						<input type="button" class="btn btn-light" data-dismiss="modal" value="Cancelar">                        
                        <a href="suppress?IdPrograma=<?php echo $row['IdPrograma'] ?>" class="btn btn-danger btn-ok" >Eliminar definitivamente</a>
					</div>
