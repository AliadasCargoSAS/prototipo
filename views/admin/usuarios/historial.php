        ...
        <div class="row">
            <div class="col" id="cont-bloque-corto">
                ...
                <?php
                    ...
                    $sql2 = mysqli_query ($link, "SELECT COUNT(*) AS TotalRegistros FROM usuarios WHERE Status = 0");
                    ...
                    FROM usuarios u WHERE Status = 0 LIMIT $desde,$porPagina";
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">			
                                                <div class="modal-header">	
                                                    ...
                                                    <h4 class="modal-title">Eliminar definitivamente usuarios</h4>
                                                    ...
                                                    <!-- <form method="POST" action="delete-all.php">-->					
                                                        <p>¿Estas seguro de eliminar definitivamente los usuarios seleccionados?</p>						
                                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">			
                                                <div class="modal-header">	
                                                    ...
                                                    <h4 class="modal-title">Restablecer usuarios</h4>
                                                    <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>                                                                            
                                                    ...
                                                    <!--  <form method="POST" action="restore-all.php">-->					
                                                        <p>¿Estas seguro de restablecer los usuarios seleccionados?</p>						
                                                    </div>
                            ...
                            echo "<p style='text-align:center;' ><em>No hay registros de usuarios eliminados</a>. </em></p>";
                        }
                    } else{
                    ...
                    <hr style="margin-top:0px">
                        <div class="text-center">
                            <div class="clearfix" style="padding:5px;margin-left:30px;margin-right:30px;">
                                <div class="hint-text">Página <b><?php echo $pagina ;?></b> de <b><?php echo $totalRegistros;?></b> usuarios eliminados</div>
                                <ul class="pagination">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					...
					<div class="modal-header">						
						<h4 class="modal-title">Eliminar definitivamente usuario</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>

                        <div class="modal-body">					
                            <p>¿Estas seguro de eliminar definitivamente el usuario?</p>
