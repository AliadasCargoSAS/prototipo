<?php
    ...
    $query = "SELECT * FROM competencias WHERE Status = 1 and IdPrincipalProgramaCompetencia = '$idPrograma'";
    ...
    $pdf->Cell(0, 5, 'REPORTE COMPETENCIAS',0 ,0 , 'C');
    ...
    $pdf->Cell(160,6,'DESCRIPCION', 0, 0,'C',1);
    $pdf->Cell(30,6,'DURACION', 0, 0,'C',1);
    $pdf->Cell(60,6,'INFORMACION', 0, 0,'C',1);
    $pdf->SetDrawColor(61, 174, 233);
    $pdf->SetLineWidth(1);
    ...
    while($row = $resultado->fetch_assoc()){
        ...
        $pdf->Cell(160,10, $row['Descripcion'],1 , 0, 'L', 1);
        $pdf->Cell(30,10, $row['Duracion'],1 , 0, 'C', 1);
        $pdf->Cell(60,10, $row['Informacion'],1 , 1, 'C', 1);
    }

    $pdf->Output('D','Reporte-Competencias.pdf');
?>