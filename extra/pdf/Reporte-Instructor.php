...
$nombreinstructor = $_GET['Nombre']; 

require '../conexion.php';
$query = "SELECT * FROM instructores WHERE Status = 1 AND Nombre = '$nombreinstructor'";
...
$pdf->Cell(0, 5, 'REPORTE DE INSTRUCTOR',0 ,0 , 'C');
...
$pdf->Output('D','Reporte de instructor.pdf');
?>