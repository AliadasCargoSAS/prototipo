...
$idambiente = $_GET['IdPrincipal']; 

require '../conexion.php';
$query = "SELECT * FROM ambientes WHERE Status = 1 AND IdPrincipal= $idambiente";
...
$pdf->Cell(0, 5, 'REPORTE AMBIENTE',0 ,0 , 'C');
...
$pdf->Output('D','Reporte ambiente.pdf');
?>