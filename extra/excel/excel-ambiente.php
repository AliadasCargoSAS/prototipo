...
$sql = "SELECT * FROM  ambientes WHERE Status = 1  and IdPrincipal = $IdPrincipal ";
...
if($result = mysqli_query($link, $sql)){
        ...
        <meta http-equiv='Content-Type' content='text/html; charset=utf-8'/>
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th></th>
                        <th><h2 style='text-align:center; font-size:26px;'><em>Ambiente</em></h2></th>
                    </tr>
                    <tr>
                    </tr> 
            </table>  
    ...
    header("Content-Disposition: attachment; filename=Ambiente-".$num_Ambiente.".xls");
